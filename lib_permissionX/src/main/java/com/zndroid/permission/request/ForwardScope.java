...
package com.zndroid.permission.request;
...
/**
 * Provide specific scopes for {@link com.zndroid.permission.callback.ForwardToSettingsCallback} to give it specific functions to call.
 * @author guolin
 * @since 2020/3/18
 */
