...
package com.zndroid.permission.callback;
...
/**
 * Callback for {@link com.zndroid.permission.request.PermissionBuilder#onExplainRequestReason(ExplainReasonCallbackWithBeforeParam)} method.
 *
 * @author guolin
 * @since 2020/6/7
 */
public interface ExplainReasonCallbackWithBeforeParam {
     ...
     * @param beforeRequest
     *          Indicate it's before or after permission request. Work with {@link com.zndroid.permission.request.PermissionBuilder#explainReasonBeforeRequest()}
     */
